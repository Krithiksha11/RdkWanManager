...
ANSC_STATUS WanManager_MAPEConfiguration(ipc_mapt_data_t *dhcp6cMAPTMsgBody)
{
    ...
    ea_len      = dhcp6cMAPTMsgBody->eaLen;
    psid_offset = dhcp6cMAPTMsgBody->psidOffset;
    AnscCopyString(v4_prefix, dhcp6cMAPTMsgBody->ruleIPv4Prefix);
    AnscCopyString(v6_prefix, dhcp6cMAPTMsgBody->ruleIPv6Prefix);
    AnscCopyString(br_prefix, dhcp6cMAPTMsgBody->brIPv6Prefix);
    ...
    dhcp6cMAPTMsgBody->psidLen = psidLen;
    dhcp6cMAPTMsgBody->psid    = psidValue;
